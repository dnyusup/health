<x-layouts.app>
    <x-slot:title>Add Vendor</x-slot:title>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Add New Vendor</h1>
                <p class="text-slate-500 mt-1">Register a new vendor into the system</p>
            </div>
        </div>
