            ...
            <ul role="list" class="-mx-2 space-y-2">
                ...
                <li>
                    <a href="{{ route('vendors.index') }}" 
                       class="nav-item group flex gap-x-3 rounded-xl p-3 text-sm leading-6 font-medium {{ request()->routeIs('vendors.*') ? 'active text-white' : 'text-slate-400 hover:text-white' }}">
                        <span class="nav-icon w-10 h-10 rounded-lg {{ request()->routeIs('vendors.*') ? 'bg-blue-500/20' : 'bg-slate-700/50 group-hover:bg-slate-600' }} flex items-center justify-center transition-all">
                            <i class="fas fa-truck text-lg {{ request()->routeIs('vendors.*') ? 'text-blue-400' : '' }}"></i>
                        </span>
                        <span class="flex flex-col justify-center">
