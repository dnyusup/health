<x-layouts.app>
    <x-slot:title>Edit Machine</x-slot:title>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Edit Machine</h1>
                <p class="text-slate-500 mt-1">{{ $machine->mach_number }}</p>
            </div>
        </div>
            ...
            <form action="{{ route('machines.update', $machine) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="mach_number"
                               name="mach_number"
                               value="{{ old('mach_number', $machine->mach_number) }}"
                    ...
                    @php
                        ...
                        $selectedMachType = old('mach_type', $machine->mach_type);
                    @endphp
                    <div>
                ...
                <div>
                    ...
                    <input type="text"
                           id="mach_area"
                           name="mach_area"
                           value="{{ old('mach_area', $machine->mach_area) }}"
                           list="mach-area-list"
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i> Update Machine
                    </button>
                </div>
            </form>
        </div>
