<x-layouts.app>
    <x-slot:title>Add Part</x-slot:title>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Add New Part</h1>
                <p class="text-slate-500 mt-1">Register a new part into the system</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            <form action="{{ route('parts.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               placeholder="e.g. Motor, Gearbox ISC/Spooler"
                               required>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="e.g. Motor gearbox tvb 218"
                           required>
                    @error('part_name')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="e.g. Motor gearbox tvb 218 line3">
                    @error('part_detail')
                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i> Save Part
                    </button>
                </div>
            </form>
        </div>
